...
## Overview
The Salary Intelligence Platform analyzes and predicts salary trends across industries, job roles, and experience levels. The system combines machine learning predictions .
...
Data Source →  Database → Data Ingestion → Data Validation → Data Transformation → Model Training → Model Evaluation → FastAPI → Docker → AWS EC2
